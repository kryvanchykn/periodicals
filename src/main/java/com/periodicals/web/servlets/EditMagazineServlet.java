...
@WebServlet("/magazines-redactor/edit-magazine")
public class EditMagazineServlet extends HttpServlet {
    private static final Logger log = LogManager.getLogger(EditMagazineServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/jsp/edit_magazine.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try{
            ...
            ml.setId((Integer) session.getAttribute("magazineId"));
            ml.setNames(names);
            ...
            DaoFactory.createMagazineDao().updateMagazine(ml);
            session.setAttribute("magazineLocalization", ml);
